...
const PrivacyPolicy = () => {
    return (
        <div className='my-2 py-2 container px-8 '>
            <h1 className='text-xl font-bold mt-4 text-center py-2 mb-2'>Privacy Policy for Kustom Parts</h1>

            <p className='text-lg  '>
                At Kustom Parts.in, accessible from <a href='https://kustomparts.in/' className='text-indigo-400'>https://kustomparts.in/</a>,
                one of our main priorities is the privacy of our visitors. <br /> <br />
                This Privacy Policy document contains types of information
                that is collected and recorded by Kustom Parts.in and how we use it.
            </p>
            ...
            <p>This Privacy Policy applies only to our online activities and
                is valid for visitors to our website with regards to the information that they shared and/or collect in Kustom Parts.in.
                This policy is not applicable to any information collected offline or via channels other than this website.
            </p>

            <h2 className='text-xl font-bold mt-4 py-2 mb-2'>Consent</h2>

            <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

            <h2 className='text-xl font-bold mt-4   py-2 mb-2'>Information we collect</h2>
            ...
            <p>If you contact us directly, we may receive additional information about you such as your name,
                email address, phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide.</p>
            <p>When you register for an Account or create an Account, we may ask for your contact information,
                including items such as name, company name, address, email address,
                and mobile number.</p>

            <h2 className='text-xl font-bold mt-4   py-2 mb-2' >How we use your information</h2>

            <p className='text-lg'>We use the information we collect in various ways, including to:</p>
            ...
            <ol>
                ...
                <li>Communicate with you, either directly or through one of our partners,
                    including for customer service, <br />
            ...
            <h2 className='text-xl font-bold mt-4   py-2 mb-2'>Log Files</h2>

            <p>Kustom Parts.in follows a standard procedure of using log files.
            ...
            <h2 className='text-xl font-bold mt-4   py-2 mb-2'>Cookies and Web Beacons</h2>

            <p>Like any other website, Kustom Parts.in uses 'cookies'.
            ...
            <h2 className='text-xl font-bold mt-4   py-2 mb-2'>Advertising Partners Privacy Policies</h2>

            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Kustom Parts.in </p>
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and
                links that appear on Kustom Parts.in, which are sent directly to users' browser. They automatically receive your IP address when this occurs.
                These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that
                you see on websites that you visit.</p>

            <p>Note that Kustom Parts.in has no access to or control over these cookies that are used by third-party advertisers.</p>


            <h2 className='text-xl font-bold mt-4   py-2 mb-2'>Third Party Privacy Policies</h2>

            <p>
                Kustom Parts.in's Privacy Policy does not apply to other advertisers or websites.
            ...
            <h2 className='text-xl font-bold mt-4   py-2 mb-2'>CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>

            <p>Under the CCPA, among other rights, California consumers have the right to:</p>
            <p>Request that a business that collects a consumer's personal data disclose the categories and specific pieces of personal data that
                a business has collected about consumers.</p>
            <p>Request that a business delete any personal data about the consumer that a business has collected.</p>
            <p>Request that a business that sells a consumer's personal data, not sell the consumer's personal data.</p>
            <p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>

            <h2 className='text-xl font-bold mt-4   py-2 mb-2'>GDPR Data Protection Rights</h2>
            ...
            <h2 className='text-xl font-bold mt-4   py-2 mb-2'>Children's Information</h2>
            ...
            <p>Kustom Parts.in does not knowingly collect any Personal Identifiable Information from children under the age of 13.
