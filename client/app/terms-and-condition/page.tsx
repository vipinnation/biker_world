...
const TermAndCondition = (props: Props) => {
  return (
    <div className="w-4/5 mx-auto">
      ...
      of Kustom Parts.in's Website, located at https://kustomparts.in. By
      accessing this website we assume you accept these terms and conditions. Do
      not continue to use Kustom Parts.in if you do not agree to take all of the
      ...
      <div className="w-4/5 mx-auto ">
        ...
        <p>
          We employ the use of cookies. By accessing Kustom Parts.in, you agreed
          to use cookies in agreement with the Kustom Parts.in's Privacy Policy.
      ...
      <div className="w-4/5 mx-auto ">
        ...
        <p>
          Unless otherwise stated, Kustom Parts.in and/or its licensors own the
          intellectual property rights for all material on Kustom Parts.in. All
          intellectual property rights are reserved. You may access this from
          Kustom Parts.in for your own personal use subjected to restrictions
        ...
        <p>
          ...
          website. Kustom Parts.in does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Kustom Parts.in,its agents and/or
          ...
          laws, Kustom Parts.in shall not be liable for the Comments or for any
          ...
          website. Kustom Parts.in reserves the right to monitor all Comments
          ...
          necessary licenses and consents to do so;<br></br>
          ...
          or present commercial activities or unlawful activity.<br></br>
          You hereby grant Kustom Parts.in a non-exclusive license to use,
          ...
          that:
          <br></br> (a) the link would not make us look unfavorably to ourselves
          or to our accredited businesses;
          <br></br> (b) the organization does not have any negative records with
          us;
          <br></br>(c) the benefit to us from the visibility of the hyperlink
          compensates the absence of Kustom Parts.in; and
          <br></br>(d) the link is in the context of general resource
          information.
          <br></br>
          <br></br>
          ...
          <br></br> (c) fits within the context of the linking party’s site. If
          you are one of the organizations listed in paragraph 2 above and are
          interested in linking to our website, you must inform us by sending an
          e-mail to Kustom Parts.in. Please include your name, your organization
          ...
          <br></br> By use of any other description of our Website being linked
          to that makes sense within the context and format of content on the
          linking party’s site.
          <br></br>No use of Kustom Parts.in's logo or other artwork will be
