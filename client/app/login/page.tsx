...
const LoginPage = (props: Props) => {
  return (
    <div>
      <div className="bg-gray-900 flex items-center justify-center px-5 py-5 h-[91vh]">
        <div
              ...
              <div>
                ...
                <div className="flex ">
                  <div className="w-full">
                    <button className="block w-full max-w-xs mx-auto bg-blue-400 hover:bg-blue-500  text-black rounded-lg p-3 font-semibold">
                      Login
                    </button>
                  </div>
                </div>
