    ...
    <div>
      <div className="flex bg-gray-100 text-gray-900">
        <aside className="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-white">
          <div className="flex w-full items-center justify-center border-b border-gray-200 p-2">
            <FaGripLines className="text-2xl" />
          </div>
          <nav className="flex flex-1 flex-col gap-y-4 pt-2">
            <Link href="/user" className="text-gary-400 group relative rounded-xl p-2 hover:bg-gray-50 text-center">
